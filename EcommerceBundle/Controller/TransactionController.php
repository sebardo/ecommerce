...
use EcommerceBundle\Services\CheckoutManager;
...
class TransactionController extends Controller
{
    ...
    public function listJsonAction()
    {
        ...
        $jsonList->setRepository($em->getRepository('EcommerceBundle:Transaction'));
    ...
    public function agreementListJsonAction($id)
    {
        ...
        $contract = $em->getRepository('EcommerceBundle:Contract')->find($id);
        /** @var \Kitchenit\AdminBundle\Services\DataTables\JsonList $jsonList */
        $jsonList = $this->get('json_list');
        $jsonList->setRepository($em->getRepository('EcommerceBundle:Transaction'));
    ...
    public function advertListJsonAction($id)
    {
        ...
        $advert = $em->getRepository('EcommerceBundle:Advert')->find($id);
        /** @var \Kitchenit\AdminBundle\Services\DataTables\JsonList $jsonList */
        $jsonList = $this->get('json_list');
        $jsonList->setRepository($em->getRepository('EcommerceBundle:Transaction'));
