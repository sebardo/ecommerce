...
class AddressController extends Controller
{
    ...
    public function getInfoAction($actorId, $id)
    {
        ...
        /** @var Address $entity */
        $entity = $em->getRepository('EcommerceBundle:Address')->findOneById($id);
     ...
     *
     * @Route("/new")
     * @Template("EcommerceBundle:Address:new.html.twig")
     */
    public function newAction(Request $request, $actorId)
    {
        ...
        if($request->getMethod() == 'POST'){
            ...
            if ($form->isSubmitted() && $form->isValid()) {
                    ...
                    $forBilling = $em->getRepository('EcommerceBundle:Address')->findOneBy(array('actor' => $entity, 'forBilling' => true));
                    if(!$forBilling) {
