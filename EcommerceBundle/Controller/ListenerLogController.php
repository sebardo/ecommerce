...
use EcommerceBundle\Entity\ListenerLog;
...
class ListenerLogController extends Controller
{
     ...
     * @Method("GET")
     * @Template("EcommerceBundle:ListenerLog:index.html.twig")
     */
    ...
    public function listJsonAction()
    {
        ...
        $jsonList->setRepository($em->getRepository('EcommerceBundle:ListenerLog'));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EcommerceBundle:ListenerLog')->find($id);
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('ecommerce_listenerlog_index'));
    }
