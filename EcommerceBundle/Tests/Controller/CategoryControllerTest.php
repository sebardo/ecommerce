 ...
 * To run the testcase:
 * @code
 * phpunit -v -c app vendor/sebardo/ecommerce/EcommerceBundle/Tests/Controller/CategoryControllerTest.php
 * @endcode
 */
class CategoryControllerTest  extends CoreTest
{
    /**
     * @code
     * phpunit -v --filter testCategoryAdmin -c app vendor/sebardo/ecommerce/EcommerceBundle/Tests/Controller/CategoryControllerTest.php
     * @endcode
     * 
     */
