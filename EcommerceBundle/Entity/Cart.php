 ...
 * 
 * @ORM\Table(name="cart")
 * @ORM\Entity(repositoryClass="EcommerceBundle\Entity\Repository\CartRepository")
 */
class Cart 
{
     ...
     * @var Collection
     * 
     * @ORM\OneToMany(targetEntity="EcommerceBundle\Entity\CartItem", mappedBy="cart",  orphanRemoval=true, cascade={"all"})
     */
    protected $items;
